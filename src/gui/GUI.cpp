...
void updateImGui() {
  ...
  if (Options::showImGui) {
    ...
    if (ImGui::Begin("BetterRenderDragon", Options::showImGui.ptr(),
      ...
      if (Options::materialBinLoaderEnabled &&
          ImGui::CollapsingHeader("MaterialBinLoader",
                                  ImGuiTreeNodeFlags_DefaultOpen)) {
        ImGui::Indent();
      ...
      if (Options::customUniformsEnabled &&
          ImGui::CollapsingHeader("CustomUniforms",
                                  ImGuiTreeNodeFlags_DefaultOpen)) {
        ImGui::Indent();
        ImGui::Unindent();
      }
    ...
    if (showModuleManager) {
      ...
      if (ImGui::Begin("BetterRenderDragon - Module Manager",
                       &showModuleManager)) {
        if (ImGui::BeginTable("modulesTable", 2,
          ...
          ImGui::TableNextRow();
          ImGui::TableSetColumnIndex(0);
          ImGui::Text("Vanilla2Deferred");
          ImGui::TableSetColumnIndex(1);
          ImGui::Checkbox("##2", Options::vanilla2DeferredEnabled.ptr());
          ...
          // ImGui::TableSetColumnIndex(1); ImGui::Checkbox("",
          // &Options::customUniformsEnabled.ptr());
...
void updateKeys() {
  ...
  bool toggleImGui =
      ImGui::IsKeyPressed((ImGuiKey)Options::uiKey.get()) && !justChangedKey;
  if (!toggleImGui)
